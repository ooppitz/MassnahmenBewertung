...
public class AlertMethoden {
		 ...
		 * @param dialogTitel
		 * @param frage
		 * @param onTop wenn true, dann wird der Dialog immer über allen Fenstern gezeigt 
		 * @return
		 */
		...
		/**
		 * Zeigt ein Alert-Fenster und erlaubt zu steuern, ob auf den Knopfdruck gewartet wird.
		 * @param alertType
		 * @param title
		 * @param text
